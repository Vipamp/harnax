...
**路径**: `vipclaw-admin/src/test/kotlin/com/vipamp/vipclaw/admin/service/impl/SysUserServiceImplTest.kt`  
**测试目标**: Service 层业务逻辑  
**Mock 工具**: Mockito  
...
**路径**: `vipclaw-admin/src/test/kotlin/com/vipamp/vipclaw/admin/service/impl/SysUserServiceImplIntegrationTest.kt`  
...
**路径**: `vipclaw-admin/src/test/kotlin/com/vipamp/vipclaw/admin/controller/SysUserControllerTest.kt`  
