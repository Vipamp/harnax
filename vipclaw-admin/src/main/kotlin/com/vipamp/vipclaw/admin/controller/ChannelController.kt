...
class ChannelController(
    ...
    fun toggleChannel(
        ...
        if (channelService.toggleChannelStatus(id, status)) ResultVo.success()
        else ResultVo.error("更新 Channel 失败")
    } catch (e: Exception) {
        log.error("更新 Channel 失败", e)
        ResultVo.error(e.message ?: "更新 Channel 失败")
    }
    ...
    fun deleteChannel(
        ...
        if (channelService.deleteChannel(id)) ResultVo.success()
        else ResultVo.error("删除 Channel 失败")
    } catch (e: Exception) {
