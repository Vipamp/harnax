...
public interface AgentService extends IService<Agent> {
     ...
     * @return 分页结果
     */
    Page<Agent> getAgentPage(String name, Integer status, Integer current, Integer size);
     ...
     * @return 创建结果
     */
    boolean createAgent(AgentCreateRequest request);
     ...
     * @return 更新结果
     */
    boolean updateAgent(Long id, AgentUpdateRequest request);
     ...
     * @return 更新结果
     */
    boolean toggleAgentStatus(Long id, Integer status);
     ...
     * @return 响应 DTO
     */
    AgentResponse convertToResponse(Agent agent);
}
