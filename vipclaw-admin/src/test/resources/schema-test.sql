...
('Default Repository', 'https://github.com/vipamp/skills', 'main', '默认技能仓库', 1, 1, 'admin', 1),
('Advanced Skills', 'https://github.com/vipamp/advanced-skills', 'master', '高级技能仓库', 1, 1, 'admin', 1),
('Deleted Repository', 'https://github.com/vipamp/deleted', 'main', '已删除仓库', 1, 1, 'admin', 0);
...
('Data Sync Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.DataSyncJob', '0 0 * * * ?', 1, 1, '数据同步任务', 1, 'admin', 1),
('Report Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.ReportJob', '0 0 8 * * ?', 1, 0, '报表生成任务', 1, 'admin', 1),
('Cleanup Job', 'SYSTEM', 'com.vipamp.vipclaw.admin.job.CleanupJob', '0 0 2 * * ?', 0, 1, '清理任务', 1, 'admin', 1),
('Deleted Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.DeletedJob', '0 0 12 * * ?', 1, 1, '已删除任务', 1, 'admin', 0);
...
(1, 'Data Sync Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.DataSyncJob', '执行成功', 1, '2026-04-25 10:00:00', '2026-04-25 10:00:05'),
(1, 'Data Sync Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.DataSyncJob', '执行成功', 1, '2026-04-25 11:00:00', '2026-04-25 11:00:03'),
(2, 'Report Job', 'DEFAULT', 'com.vipamp.vipclaw.admin.job.ReportJob', '执行失败：数据库连接超时', 0, '2026-04-25 08:00:00', '2026-04-25 08:05:00');
