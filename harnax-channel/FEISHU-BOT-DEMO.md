...
mvn compile -pl harnax-channel -am

# 运行演示（需要在 IDE 中运行）
# 打开文件: harnax-channel/src/main/kotlin/com/agnetix/harnax/channel/demo/FeishuBotDemo.kt
...
curl -X POST 'YOUR_WEBHOOK_URL' \
  -H "Content-Type: application/json" \
  -d '{"msg_type":"text","content":{"text":"🤖 这是来自 Harnax Channel 的测试消息！"}}'
```
