    ...
    >
      ...
      >
        ...
        <Form.Item name="jobClass" label={intl.formatMessage({ id: 'pages.job.jobClass', defaultMessage: '执行类' })}
          ...
          tooltip={{ title: intl.formatMessage({ id: 'pages.job.jobClass.tooltip', defaultMessage: '必须是继承 BaseJob 的类全路径，例如：job.com.vipamp.vipclaw.admin.SampleJob' }), icon: <QuestionCircleOutlined /> }}>
          <Input placeholder={intl.formatMessage({ id: 'pages.job.jobClass.placeholder', defaultMessage: '例如：job.com.vipamp.vipclaw.admin.SampleJob' })} />
        </Form.Item>
