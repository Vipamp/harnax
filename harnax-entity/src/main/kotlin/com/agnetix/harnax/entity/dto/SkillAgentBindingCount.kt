 ...
 * columns; a [com.agnetix.harnax.entity.AgentSkillBinding] row would carry an `id` and timestamps no
 * caller of this query may look at, and one row per binding is the N+1 this grouping exists to
 * avoid. Mutable with a no-arg constructor so MyBatis maps it by setter.
 */
