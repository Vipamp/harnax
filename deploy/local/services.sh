...
SERVICES=(
    "admin|harnax-admin/target/harnax-admin-*-exec.jar|${ADMIN_PORT}|${COMMON_ENV} SPRING_DATASOURCE_URL=${ADMIN_DB_URL} SPRING_DATASOURCE_USERNAME=${DB_USERNAME} SPRING_DATASOURCE_PASSWORD=${DB_PASSWORD} SESSION_JDBC_URL=${ADMIN_DB_URL} SESSION_USERNAME=${DB_USERNAME} SESSION_PASSWORD=${DB_PASSWORD} HARNAX_ROUTER_URL=http://localhost:${ROUTER_PORT} HARNAX_SCHEDULER_URL=http://localhost:${SCHEDULER_PORT} HARNAX_ROUTER_EXTERNAL_URL=http://120.26.245.51:3389"

    "router|harnax-session-router/target/harnax-session-router-*.jar|${ROUTER_PORT}|CACHE_TYPE=${CACHE_TYPE} ROUTER_DB_URL=${ROUTER_DB_URL} ROUTER_DB_DRIVER=${ROUTER_DB_DRIVER} ADMIN_SERVICE_URL=http://localhost:${ADMIN_PORT} ADMIN_INTERNAL_API_SECRET=${ADMIN_INTERNAL_API_SECRET} HARNAX_AUTH_SECRET=${HARNAX_AUTH_SECRET} ROUTER_CORS_ALLOWED_ORIGINS=*"
    ...
    "channel|harnax-channel/harnax-channel-service/target/harnax-channel-service-*.jar|${CHANNEL_SERVICE_PORT}|SPRING_DATASOURCE_URL=${ADMIN_DB_URL} SPRING_DATASOURCE_USERNAME=${DB_USERNAME} SPRING_DATASOURCE_PASSWORD=${DB_PASSWORD} ROUTER_URL=http://localhost:${ROUTER_PORT} ADMIN_SERVICE_URL=http://localhost:${ADMIN_PORT} ADMIN_INTERNAL_API_SECRET=${ADMIN_INTERNAL_API_SECRET} HARNAX_AUTH_SECRET=${HARNAX_AUTH_SECRET}"
)
