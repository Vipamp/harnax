// pages/channel/list/index.ts
import { getChannelPage, toggleChannel, deleteChannel } from '../../../services/channel';
import { PAGE_SIZE } from '../../../utils/constants';

Page({
  data: {
    list: [] as API.ChannelItem[],
    keyword: '',
    pageNum: 1,
    total: 0,
    loading: false,
  ...
  onCreate() {
    wx.navigateTo({ url: '/pages/channel/form/index' });
  },
});
