...
import com.vipamp.vipclaw.channel.message.MarkdownRichMessage
import com.vipamp.vipclaw.channel.message.TextRichMessage
...
object FeishuBotDemo {
    ...
    private fun demonstrateRichMessages() {
        ...
        val textJson = com.vipamp.vipclaw.channel.adaptor.feishu.FeishuMessageBuilder.buildFromRichMessage(textMessage)
