...
object DingTalkMessageBuilder {
     ...
     */
    fun buildMarkdown(title: String, content: String): Map<String, Any> {
        return mapOf(
            "msgtype" to "markdown",
            "markdown" to mapOf(
                "title" to title,
     ...
     */
    fun buildImage(mediaId: String, imageUrl: String? = null): Map<String, Any> {
        return mapOf(
            "msgtype" to "image",
            "image" to mapOf(
     ...
     */
    fun buildFile(fileName: String, fileUrl: String): Map<String, Any> {
