...
import com.agnetix.harnax.admin.entity.Tenant
...
- **注解位置**：`com.agnetix.harnax.admin.annotation.SkipTenantFilter`
- **拦截器**：`com.agnetix.harnax.admin.interceptor.MybatisTenantInterceptor`
