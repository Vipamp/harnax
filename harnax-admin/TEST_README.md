...
```
harnax-admin/src/test/kotlin/com/agnetix/harnax/admin/
├── service/impl/
...
mvn clean test -pl harnax-admin
```
...
```bash
# 运行所有集成测试
mvn test -pl harnax-admin -Dtest=SysUserMapperIntegrationTest,SysUserServiceImplIntegrationTest

# 只运行 Mapper 集成测试
mvn test -pl harnax-admin -Dtest=SysUserMapperIntegrationTest

# 只运行 Service 集成测试
mvn test -pl harnax-admin -Dtest=SysUserServiceImplIntegrationTest
```
...
```bash
# 运行所有单元测试
mvn test -pl harnax-admin -Dtest=SysUserServiceImplTest,SysUserMapperUnitTest

# 只运行 Service 单元测试
mvn test -pl harnax-admin -Dtest=SysUserServiceImplTest

# 只运行 Mapper 单元测试
mvn test -pl harnax-admin -Dtest=SysUserMapperUnitTest
```

### 运行单个测试方法

```bash
mvn test -pl harnax-admin -Dtest=SysUserMapperIntegrationTest#selectById should return user when exists
```
...
- Service实现: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/service/impl/SysUserServiceImpl.kt`
- Mapper接口: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/mapper/SysUserMapper.kt`
- 实体类: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/entity/SysUser.kt`
- DTO类: 
