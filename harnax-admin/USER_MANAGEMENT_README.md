...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/entity/SysUser.kt`
...
**文件**: 
- `harnax-admin/src/main/resources/db/schema.sql` (主库)
- `harnax-admin/src/test/resources/schema-test.sql` (测试库)
...
**文件**: `harnax-admin/src/main/resources/mapper/SysUserMapper.xml`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/dto/SysUserCreateRequest.kt`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/dto/SysUserUpdateRequest.kt`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/dto/SysUserResponse.kt`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/service/SysUserService.kt`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/service/impl/SysUserServiceImpl.kt`
...
**文件**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/controller/SysUserController.kt`
...
**文件**: `harnax-admin/src/test/kotlin/com/agnetix/harnax/admin/service/impl/SysUserServiceImplTest.kt`
...
**文件**: `harnax-admin/src/test/kotlin/com/agnetix/harnax/admin/service/impl/SysUserServiceImplIntegrationTest.kt`
...
**文件**: `harnax-admin/src/test/kotlin/com/agnetix/harnax/admin/controller/SysUserControllerTest.kt`
...
```bash
# 执行迁移脚本
mysql -u root -p harnax < sql/user_table_migration.sql
```
...
```bash
# 执行完整 schema
mysql -u root -p < harnax-admin/src/main/resources/db/schema.sql
```
...
| 文件 | 路径 | 说明 |
|------|------|------|
| SysUser.kt | harnax-admin/src/main/kotlin/.../entity/ | 用户实体类 |
| SysUserCreateRequest.kt | harnax-admin/src/main/kotlin/.../dto/ | 创建请求 DTO |
| SysUserUpdateRequest.kt | harnax-admin/src/main/kotlin/.../dto/ | 更新请求 DTO |
| SysUserResponse.kt | harnax-admin/src/main/kotlin/.../dto/ | 响应 DTO |
| SysUserService.kt | harnax-admin/src/main/kotlin/.../service/ | 服务接口 |
| SysUserServiceImpl.kt | harnax-admin/src/main/kotlin/.../service/impl/ | 服务实现 |
| SysUserController.kt | harnax-admin/src/main/kotlin/.../controller/ | 控制器 |
| SysUserMapper.kt | harnax-admin/src/main/kotlin/.../mapper/ | Mapper 接口 |
| SysUserMapper.xml | harnax-admin/src/main/resources/mapper/ | Mapper XML |

### 测试代码

| 文件 | 路径 | 说明 |
|------|------|------|
| SysUserServiceImplTest.kt | harnax-admin/src/test/kotlin/.../service/impl/ | 单元测试 |
| SysUserServiceImplIntegrationTest.kt | harnax-admin/src/test/kotlin/.../service/impl/ | 集成测试 |
| SysUserControllerTest.kt | harnax-admin/src/test/kotlin/.../controller/ | Controller 测试 |
| schema-test.sql | harnax-admin/src/test/resources/ | 测试数据库脚本 |

### 数据库脚本

| 文件 | 路径 | 说明 |
|------|------|------|
| schema.sql | harnax-admin/src/main/resources/db/ | 主库建表脚本 |
...
| USER_MANAGEMENT_TEST_GUIDE.md | harnax-admin/ | 测试指南 |
| README.md | harnax-admin/ | 本文件 |
...
- 测试指南: `harnax-admin/USER_MANAGEMENT_TEST_GUIDE.md`
