...
**文件路径**: `harnax-admin/src/main/resources/mapper/SysUserMapper.xml`
...
**文件路径**: `harnax-admin/src/main/kotlin/com/agnetix/harnax/admin/mapper/SysUserMapper.kt`
...
**文件路径**: `harnax-admin/src/main/resources/application.yml`

**新增配置**:
```yaml
mybatis:
  mapper-locations: classpath:mapper/*.xml  # XML 文件位置
  type-aliases-package: com.agnetix.harnax.admin.entity  # 实体类别名
  configuration:
...
```xml
<!-- 定义一次，多处复用 -->
<resultMap id="SysUserResultMap" type="com.agnetix.harnax.admin.entity.SysUser">
...
harnax-admin/
├── src/main/
│   ├── kotlin/com/agnetix/harnax/admin/mapper/
...
mvn clean compile -pl harnax-admin -am
```

✅ **测试编译成功**
```bash
mvn clean test-compile -pl harnax-admin -am
```
