 ...
 * @param cliPackageBucket bucket holding the CLI plugin packages admin registered
...
data class MinioConfig(
    ...
    val cliPackageBucket: String = "harnax-cli-packages",
    ...
    fun ensureBuckets(minioClient: MinioClient = createMinioClient()) {
        ...
        ensureBucket(minioClient, cliPackageBucket)
    }
